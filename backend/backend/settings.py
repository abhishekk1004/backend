...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-@3$)-o@#how#l1xmhl_=0&uz8dg14p+8957!l3m%=_h6+0g-p(')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@abhishek-kushwaha.com.np')
...
REST_FRAMEWORK = {
    # Avoid Django session auth (and its CSRF requirement) for API calls from the frontend
